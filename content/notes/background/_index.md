+++
date = '2026-02-08T08:54:31-08:00'
title = 'Background'
+++
...
This was also during an era where being gay hadn’t been completely normalized so it seemed like a genuine distinction when contemplating parenthood (abstractly, this was a long time before parenting was an active consideration in my life) that a parent might have a child who comes out as gay and the parent is not hugely pro-gay, and it seemed non-trivial to conclude that the parent should try to step outside their own values and decide whether their child is going to better pursue eudaemonia (or whatever your model of flourishing is) if supported in their sexuality than by trying to change or suppress it, even without disputing the abstract morality of homosexuality itself. And once you start thinking along those lines, it starts to cohere kind of naturally.

Now, to your actual question: I think as a child gets older it becomes clearer and clearer what their own values and beliefs are independent of the parent’s. I also think the impact of supporting their values when they diverge becomes greater in rough correlation. Put another way, when a child is an infant they have barely any distinct values so just doing what’s “best for them” is probably pretty close to what their future self would have chosen for themselves, and even if different is unlikely to create long-term problems. And when a child is 18 you can have a pretty good idea of the sort of person they are and the impact of ignoring that is more severe.

I think the critical distinction is that “what’s best for them” is using the parent’s values and operating as a fiduciary is using the parent’s best judgment of what the child’s future values will be. As the parent you’re working for the adult version of the child, not yourself and not the current child.
...
Example: A parent who works more to provide financial stability for the child is serving the child's future interests. But a parent who works more because they find work fulfilling and home life draining might be rationalizing self-interest as fiduciary duty. And here's the uncomfortable part — the same parent might be doing both simultaneously, and they might not be able to tell you where one ends and the other begins.
